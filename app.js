...
//  function problemTwo(){
//     let response = prompt('What cuisine would you like?')
//     let results = dishes.filter(function(dish){
//             if(dish.cuisine === response ){
//                 return true;
//             }
//             else{
//                 return false;
...
//  let fiveServings = problemThree();
//  console.log(fiveServings)
...
//     return results;
// }
// let equalServings = problemFive();
// console.log(equalServings);
...
//     return results;
// }
//  let includesOption = problemSix();
//  console.log(includesOption)

//7. Create a function that will prompt the user to type the name of one ingredient. Then use a filter to find all the dishes whose ingredients array INCLUDES that ingredient. Return the new array.
//Filter

// function problemSeven(){
//     let response = prompt('Name one ingredient.')
//     let results = dishes.filter(function(dish){
...
//     return results;
// }
// let userIngredient = problemSeven();
...
function problemTen(){
    ...
    let advancedArray = results.map(function(dish){
        return `${dish.cuisine} ${dish.name}`
    })
    return advancedArray

}
let dishesArray = problemTen();
